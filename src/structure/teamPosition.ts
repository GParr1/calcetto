export const teamPosition = [
  ...
  { value: 'CDC', label: 'Mediano (Centrocampista Difensivo)' },
  { value: 'COC', label: 'Trequartista (Centrocampista Offensivo)' },
  { value: 'AD', label: 'Ala Destra' },
  { value: 'AS', label: 'Ala Sinistra' },
  { value: 'ATT', label: 'Attaccante Centrale' },
  { value: 'SP', label: 'Seconda Punta' }
]
